...
game.o: game.c ../../drivers/avr/system.h ../../drivers/navswitch.h game_display.h transmit.h ../../utils/pacer.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o game_setup.o system.o game_display.o transmit.o ir_uart.o font.o pacer.o tinygl.o timer.o pio.o ledmat.o display.o navswitch.o timer0.o usart1.o prescale.o navinput.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
